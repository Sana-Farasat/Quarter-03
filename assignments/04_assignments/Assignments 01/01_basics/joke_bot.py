...
JOKE: str = "Here's a joke for you! Why did the developer go broke? Because he used up all his cache!"
SORRY: str = "Oops! I only know how to tell jokes. Type exactly: Joke"
...
def main():
    ...
    user_input = user_input.strip().lower() # strip will remove extra spaces from start and end..
